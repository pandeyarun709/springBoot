...
public class EmpController {
    ...
    public void updateEmp(@RequestBody Emp emp , @PathVariable String id) {
		...
		empS.updateEmp(emp , id);
				
	 }
	
	@RequestMapping(method=RequestMethod.DELETE , value="/getEmp/{id}")
    public void updateEmp(@PathVariable String id) {
